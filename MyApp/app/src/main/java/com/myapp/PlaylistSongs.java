...
public class PlaylistSongs extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lv = (ListView) rootView.findViewById(R.id.playlist_songs);

        ad1 = new MyCustomListAdapter(getContext(),R.layout.custom_list_item,Playlists.playlistSongsData);
        lv.setAdapter(ad1);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MainActivity.currentlyPlaying = Playlists.playlistSongsData;
        ...
        lv.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
                ...
                if(checked) {
                    ++count;
                    selectedItems.add(Playlists.playlistSongsData.get(position));
                } else {
                    --count;
                    selectedItems.remove(Playlists.playlistSongsData.get(position));
                }
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                count = 0;
                MainActivity.currentFragment="PlaylistSongs";
        ...
        rootView.setOnKeyListener( new View.OnKeyListener()
        {
            ...
            public boolean onKey( View v, int keyCode, KeyEvent event )
            {
                if( keyCode == KeyEvent.KEYCODE_BACK )
                {
                    ...
                    if(Playlists.lv != null)
                        Playlists.lv.setVisibility(View.VISIBLE);
                    return true;
                }
                return false;
            }
